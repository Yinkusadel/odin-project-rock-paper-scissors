...
const changeComRock = () => {
  ...
  let compSvgRock = document.querySelector('.computer-option-svg-computer path');
...
const changeComPaper = () => {
  ...
  let compSvgPaper = document.querySelector('.computer-option-svg-computer path');
...
const changeComScissors = () => {
  ...
  let compSvgScissors = document.querySelector('.computer-option-svg-computer path');
...
const getPlayerRock = () => {
  ...
  let playerSvgRock = document.querySelector('.player-option-svg-player path');
